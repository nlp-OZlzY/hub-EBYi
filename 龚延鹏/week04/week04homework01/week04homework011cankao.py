...
dataset = load_dataset(r"D:/nlp20/龚延鹏(作业)/week04/week04homework01/laws.csv")
...
# 从预训练模型加载分词器和模型
tokenizer = BertTokenizer.from_pretrained(r'D:\model\bert-base-chinese')
model = BertForSequenceClassification.from_pretrained(r'D:\model\bert-base-chinese', num_labels=8)
...
training_args = TrainingArguments(
    ...
    weight_decay=1e-3,                   # 权重衰减，用于防止过拟合
