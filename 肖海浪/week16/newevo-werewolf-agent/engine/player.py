...
封装游戏中玩家的属性和行为，桥接角色（Role）和 AI 代理（PlayerAgent）。
"""
...
class Player:
    ...
    包含玩家的角色信息和 AI 代理，提供角色属性的便捷访问
    （role_type、camp、is_alive 等直接代理到 role 对象）。
    """
    player_id: int
    role: BaseRole
    agent: Optional["PlayerAgent"] = None  # 玩家控制的AI代理
    name: str = ""  # 玩家名称
